...
# --- CONVENTIONS ---------------------------------------------------------
TIME_UTC = True          # True: normalise to ...Z   False: keep an offset
ID_PREFIXED = True       # True: "site_a.csv:R-1001" False: "R-1001"
MISSING_NOTE = ""        # ""  or  None
ID_FIELD = "record_id"   # the half-applied rename: record_id or case_id
# Mixed variant only: apply the id convention differently to fixed-width rows.
